...
const DriverRegistration = () => {
  const [formData, setFormData] = useState({
    user_id: 82833,
    email: 'drivermark@gmail.com',
    givenname: 'drivermark',
    surname: 'drivermark',
    middle_name: 'drivermark',
    phone: 'drivermark',
    address: 'drivermark',
    the_password: 'drivermark',
    username: 'drivermark',
    salt: 'drivermark',
    government_id: '110292',
  });
  const goToHomePage = () => {
  ...
  const handleRegistration = async () => {
    try {
      const response = await axios.post(
        'https://swebackendmars.onrender.com/api/the_admin/register_driver',
        {
      ...
      setRegistrationMessage(`Driver registered successfully. User ID: ${user_id}. Message: ${message}`);
    } catch (error) {
